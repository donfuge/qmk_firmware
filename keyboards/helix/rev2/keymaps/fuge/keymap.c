...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_QWERTY] = LAYOUT( \
      ...
      KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    HU_LPRN, HU_RPRN, KC_N,    KC_M,    HU_COMM, HU_DOT,  HU_MINS, KC_ENT , \
  ...
  [_LOWER] = LAYOUT( \
      ...
      KC_ENTER, HU_BSLS, HU_PIPE,   HU_SLSH, HU_HASH,  HU_PERC,                   HU_CIRC, HU_AMPR, HU_ASTR, HU_LPRN, HU_RPRN, KC_DEL, \
      KC_DEL, HU_DOT,   HU_SCLN,   HU_LESS,   HU_EQL,   HU_MORE,                     HU_DLR,   HU_MINS, HU_PLUS, HU_LCBR, HU_RCBR, HU_PIPE, \
      UNDO, HU_CIRC,   HU_AMPR,   HU_LESS,  HU_EQL, HU_MORE,  HU_LBRC, HU_RBRC, HU_BSLS,  HU_UNDS, KC_PSCR, KC_HOME, KC_END,  _______, \
   ...
   * |------+------+------+------+------+------+------+------+------+------+------+------+------+------|
   * | UNDO |   ^  |  &   |   #  |   @  |  F11 |  {   |   }  |  ;   |  _   |A_PSCR|PageDn|PageUp|      |
   * |------+------+------+------+------+------+------+------+------+------+------+------+------+------|
   * |      |      |      |      |      |      |      |      |      |      | Next | Vol- | Vol+ | Play |
   * `-------------------------------------------------------------------------------------------------'
   */
  [_RAISE] = LAYOUT( \
      ...
      HU_TILD,  HU_BSLS,    HU_PIPE,    HU_SLSH,    HU_HASH,    HU_EXLM,         HU_DOT,    HU_UU,    HU_II,    HU_OEE,    HU_UEE,    KC_BSPC,  \
      KC_DEL, HU_PERC,   HU_LCBR,   HU_RCBR,   HU_LBRC, HU_RBRC,                     KC_LEFT,   KC_DOWN, KC_UP,  KC_RIGHT, HU_SLSH, HU_BSLS, \
      UNDO, HU_CIRC,   HU_AMPR,   HU_HASH,   HU_AT,  KC_F11,  HU_LCBR, HU_RCBR, HU_SCLN,  HU_UNDS, LALT(KC_PSCR), KC_PGDN, KC_PGUP, _______, \
      _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_MNXT, KC_VOLD, KC_VOLU, KC_MPLY \
      ),

  /* Adjust (Lower + Raise)
   * ,-----------------------------------------.             ,-----------------------------------------.
   * |   ALT+F12  |   ALT+F1  |   ALT+F2  |  ALT+F3 |   ALT+F4  |  ALT+ F5  |             |   ALT+F6  |   ALT+F7  |   ALT+F8  |   ALT+F9 |   ALT+F10 |   ALT+F11 |
   * |------+------+------+------+------+------|             |------+------+------+------+------+------|
   * |      | Reset|RGBRST|  RED |GREEN | BLUE |             |      |      |      |      |      |  Del |
   * |------+------+------+------+------+------|             |------+------+------+------+------+------|
